...
RUN apt-get update -y && apt update -y && apt-get install -y curl && apt-get update && apt-get install libgl1 -y && apt install python3.8 python3-dev python3-pip -y && alias python=python3.8
