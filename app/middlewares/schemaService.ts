...
export function validateSchemaService (req: Request, res: Response, next: NextFunction): void {
    let missingFields = '';
    missingFields = validateGenericParameter(req.body.carer, missingFields, 'carer');
    missingFields = validateGenericParameter(req.body.description, missingFields, 'description');
